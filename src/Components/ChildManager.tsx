            ...
            >
                <div className="p-6 border-b bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                    <div className="flex items-center justify-between">
                        <Text size="5" weight="bold">Manage Children</Text>
                                    ...
                                    <div className="flex-1">
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                value={child.name}
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateChild(child.id, 'name', e.target.value)}
                                    ...
                                    <div className="flex-1">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateChild(child.id, 'wakeUpTime', e.target.value)}
                                                className="pl-10 w-full rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1">
                                        <div className="relative">
                                            ...
                                            <input
                                                type="time"
                                                value={child.busTime}
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateChild(child.id, 'busTime', e.target.value)}
                                                className="pl-10 w-full rounded-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            />
                                        </div>
                                    </div>
                ...
                <div className="p-6 border-t bg-gray-50 flex justify-end gap-3">
                    ...
                    <Button onClick={() => onSave(editedChildren)}>
                        Save Changes
                    </Button>
                </div>
            </motion.div>
